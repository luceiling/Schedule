/** @license
 * DayPilot Pro for JavaScript 2026.2.6907
...
export namespace DayPilot {
    ...
    export class SchedulerPropsAndEvents {
        ...
        rowHeaderColumnBubble?: DayPilot.Bubble;
        ...
        scaleManualLimitBeyond?: boolean;
        ...
        timeHeaderRightClickHandling?: "Enabled" | "Disabled";
        ...
        onScrollEnd?: EventHandler<SchedulerScrollEndArgs>;
    ...
    export interface SchedulerScrollEndArgs {
        readonly control: DayPilot.Scheduler;
        readonly viewport: SchedulerViewport;
        async: boolean;
        events: EventData[];
    ...
    export class CalendarPropsAndEvents {
        ...
        cornerHtml?: string;
        cornerText?: string;
        crosshairType?: "Header" | "Full" | "Disabled";
        cssClass?: string;
        ...
        eventResizingStartEndEnabled?: boolean;
        eventResizingStartEndFormat?: string;
        eventRightClickHandling?: "ContextMenu" | "Disabled" | "CallBack" | "Bubble" | "Enabled";
        eventSelectHandling?: "Update" | "CallBack" | "Disabled";
        eventsLoadMethod?: "GET" | "POST";
        eventTapAndHoldHandling?: "Move" | "ContextMenu";
        exceljs?: any;
        headerClickHandling?: "Enabled" | "CallBack" | "Disabled";
        ...
        timeRangeSelectingStartEndEnabled?: boolean;
        timeRangeSelectingStartEndFormat?: string;
        timeRangeTapAndHoldHandling?: "Select" | "ContextMenu";
        useEventBoxes?: "Always" | "Never" | "ShortEventsOnly";
        ...
        onTimeRangeRightClick?: EventHandler<CalendarTimeRangeRightClickArgs>;
        onTimeRangeRightClicked?: EventHandler<CalendarTimeRangeRightClickedArgs>;
    ...
    export class Calendar extends CalendarPropsAndEvents {
        ...
        columns: {
            ...
            find(date: DayPilot.Date, id?: ResourceId): DayPilot.Column;
            filter(param: any): void;
        };
        events: {
            list: EventData[];
        ...
        startAutoRefresh(force?: boolean): void;
    ...
    export interface CalendarEventDoubleClickedArgs {
        readonly e: DayPilot.Event;
    }
    ...
    export interface CalendarTimeRangeRightClickArgs {
        readonly start: DayPilot.Date;
        readonly end: DayPilot.Date;
        readonly resource: ResourceId;
        preventDefault(): void;
    ...
    export interface CalendarTimeRangeRightClickedArgs {
        readonly start: DayPilot.Date;
        readonly end: DayPilot.Date;
        readonly resource: ResourceId;
    }
    ...
    export class MonthPropsAndEvents {
        ...
        headerHeight?: number;
        heightSpec?: "Auto" | "Fixed" | "Parent100Pct";
        hideUntilInit?: boolean;
        lineSpace?: number;
        loadingLabelText?: string;
        loadingLabelHtml?: string;
        ...
        onAutoRefresh?: EventHandler<MonthAutoRefreshArgs>;
    ...
    export class Month extends MonthPropsAndEvents {
        ...
        static makeDraggable(options: MonthMakeDraggableOptions): void;
    }

    export interface MonthMakeDraggableOptions {
        element: HTMLElement;
        keepElement?: boolean;
        remove?: HTMLElement;

        data?: MonthMakeDraggableData;

        externalCssClass?: string;
        externalHtml?: string;
        externalCursor?: string;

        onDragStart?: EventHandler<MonthMakeDraggableDragStartArgs>;
        onDrop?: EventHandler<MonthMakeDraggableDropArgs>;
    }

    export interface MonthMakeDraggableData {
        id: EventId;
        text: string;
        duration: number | DayPilot.Duration;
    }

    export interface MonthMakeDraggableDragStartArgs {
        readonly options: MonthMakeDraggableOptions;
    }

    export interface MonthMakeDraggableDropArgs {
        readonly options: MonthMakeDraggableOptions;
    }
    ...
    export interface MonthAutoRefreshArgs {
        readonly i: number;
        preventDefault(): void;
    }

    export interface MonthBeforeCellDomAddArgs {
        readonly control: Month;
        readonly cell: {
            start: DayPilot.Date;
            end: DayPilot.Date;
            events(): DayPilot.Event[];
    ...
    export class KanbanPropsAndEvents {
        ...
        cardDoubleClickHandling?: "Enabled" | "Disabled" | "Edit" | "Select" | "ContextMenu" | "Bubble";
        cardHeight?: number;
        ...
        onCardMoving?: EventHandler<KanbanCardMovingArgs>;
    ...
    export interface KanbanCardMovingArgs {
        allowed: boolean;
        readonly ctrl: boolean;
        readonly shift: boolean;
        readonly meta: boolean;
